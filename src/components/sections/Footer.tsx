...
export function Footer() {
  ...
  return (
    <footer className="bg-[#080808] border-t border-white/5 py-10 px-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <motion.button
            ...
            className="ml-2 w-8 h-8 glass rounded-lg flex items-center justify-center text-white/40 hover:text-white border border-white/10 transition-colors"
          >
            <ArrowUp size={14} />
          </motion.button>
        </div>
