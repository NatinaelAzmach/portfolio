...
export const PROJECTS: Project[] = [
  {
    id: '5',
    title: 'Gursha Ratings',
    description: 'Explore and rate restaurants & cafes across Addis Ababa, see what friends are eating, and climb the leaderboard.',
    longDescription:
      'A food discovery and social rating app focused on Addis Ababa\'s restaurant and cafe scene. Users can browse venues, leave ratings and reviews, and follow friends to see their latest picks. A competitive leaderboard tracks top reviewers with different badges — from "Tej Taster" to "Gursha Legend" — rewarding the most active and trusted voices in the community.',
    category: 'fullstack',
    tags: ['React', 'Node.js', 'MongoDB', 'Firebase', 'Tailwind'],
    image: '/Gursha Ratings.png',
    demoUrl: 'https://gursha-ratings.vercel.app',
  ...
  },
  {
    ...
    category: 'fullstack',
    tags: ['React', 'Node.js', 'MongoDB', 'Firebase', 'Tailwind'],
    image: '/unimatch-screenshot.png',
    demoUrl: 'https://uni-match-n.vercel.app',
    githubUrl: 'https://github.com/NatinaelAzmach/meh',
    featured: true,
  },
  {
